...
LRESULT AboutPage::OnCommand( UINT nNotifyCode, UINT nCtrlID, HWND hWndCtrl )
{
	...
	if ( nCtrlID == IDC_MORE )
	{
		...
		mb.Body().Format( ISEQ_BOLD ISEQ_UNDERLINE _T( "Brainchild Configuration Tool\n" )
				  ...
				  ISEQ_TEXTRGB( "0,0,150" ) _T( "ColourPopup" ) ISEQ_TEXTSYSCOLOR( IG_COLOR_BTNTEXT )
				  _T( " - (C) 1998 Chris Maunder ( www.codeproject.com )\n" )
				  ISEQ_TEXTRGB( "0,0,150" ) _T( "BalloonHelp" ) ISEQ_TEXTSYSCOLOR( IG_COLOR_BTNTEXT )
				  _T( " - (C) 2001 Joshua Heyer\n" )
				  ISEQ_TEXTRGB( "0,0,150" ) _T( "OddButton" ) ISEQ_TEXTSYSCOLOR( IG_COLOR_BTNTEXT )
