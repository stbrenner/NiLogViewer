...
BOOL BCToolbar::Create( ClsWindow *pParent, ClsMRU *pMRU )
{
	...
	if ( m_Tools.CreateMappedBitmap( IDB_TOOLBAR, 0, &cMap, 1 ))
	{
		...
		if ( ClsToolbar::Create( pParent, rcEmpty, 0, WS_CHILD | WS_VISIBLE | TBSTYLE_TOOLTIPS | TBSTYLE_FLAT ))
		{
			...
			m_tbTools[ 3  ].iBitmap = nBase + 26; // Close
			m_tbTools[ 5  ].iBitmap = nBase +  3; // Save All
			m_tbTools[ 28 ].iBitmap = nBase +  9; // Exit
			m_tbTools[ 18 ].iBitmap = nBase + 18; // Toggle Bookmark
			m_tbTools[ 19 ].iBitmap = nBase + 16; // Next Bookmark
			m_tbTools[ 20 ].iBitmap = nBase + 17; // Prev Bookmark
			m_tbTools[ 21 ].iBitmap = nBase + 15; // Clear Bookmarks
			m_tbTools[ 24 ].iBitmap = nBase + 27; // Page setup.
...
TBBUTTON	BCToolbar::m_tbTools[ 29 ] = 
{
	{ STD_FILENEW,		IDM_NEW,	TBSTATE_ENABLED,  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "New" ),		0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	{ STD_FILEOPEN,		IDM_OPEN,	TBSTATE_ENABLED,  TBSTYLE_DROPBT, { 0, 0 }, ( DWORD )_T( "Open" ),		0 },
	{ 0,			IDM_CLOSE,	0,                TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Close" ),		0 },
	{ STD_FILESAVE,		IDM_SAVE,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Save" ),		0 },
	{ 0,			IDM_SAVEALL,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Save All" ),		0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	{ STD_CUT,		IDM_CUT,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Cut" ),		0 },
	{ STD_COPY,		IDM_COPY,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Copy" ),		0 },
	{ STD_PASTE,		IDM_PASTE,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Paste" ),		0 },
	{ STD_DELETE,		IDM_DELETE,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Delete" ),		0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	{ STD_UNDO,		IDM_UNDO,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Undo" ),		0 },
	{ STD_REDOW,		IDM_REDO,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Redo" ),		0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	{ STD_FIND,		IDM_FIND,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Find" ),		0 },
	{ STD_REPLACE,		IDM_REPLACE,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Replace" ),		0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	...
	{ 0,			IDM_PAGESETUP,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Page Setup" ),	0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	{ STD_PROPERTIES,	IDM_PROPERTIES,	0,		  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Properties" ),	0 },
	{ 0,			0,		TBSTATE_ENABLED,  TBSTYLE_SEP,    { 0, 0 }, 0,					0 },
	{ 0,			IDM_EXIT,	TBSTATE_ENABLED,  TBSTYLE_BUTTON, { 0, 0 }, ( DWORD )_T( "Exit" ),		0 },
};