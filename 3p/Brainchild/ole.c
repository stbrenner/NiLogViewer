...
typedef ULONG ( STDMETHODCALLTYPE *IDataObject_QueryInterface )( LPDATAOBJECT, REFIID, LPVOID * );
typedef ULONG ( STDMETHODCALLTYPE *IDropSource_QueryInterface )( LPDROPSOURCE, REFIID, LPVOID * );
typedef ULONG ( STDMETHODCALLTYPE *IDropTarget_QueryInterface )( LPDROPTARGET, REFIID, LPVOID * );
...
static LRESULT STDMETHODCALLTYPE IUnknown_QueryInterface( LPUNKNOWN lpu, REFIID riid, LPVOID *lplpvObject )
{
	LPUINTERFACE	lpi = ( LPUINTERFACE )lpu;
