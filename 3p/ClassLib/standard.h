...
// Import ADO stuff?
#ifdef _IMPORT_ADO_
#import "..\..\3p\msado\msado15.dll" rename("EOF", "EndOfFile")
#import "..\..\3p\msado\msadox.dll"  
#import "..\..\3p\msado\MSJRO.DLL" no_namespace
#endif
...
#pragma warning( disable: 4710 4100 )
	...
	#define _NO_COPY(c)		private: c(const c& src) {;} void operator=(const c& src ) {;}
	#define _NO_COPY_PARAM(c,p)	private: c(const c& src) : p(0) {;} void operator=(const c& src ) {;}
...
// application.cpp defined routines.
extern ClsApp *ClsGetApp();
extern HINSTANCE ClsGetInstanceHandle();
extern HINSTANCE ClsGetResourceHandle();
extern HCURSOR ClsGetCursor( int nCursor );
